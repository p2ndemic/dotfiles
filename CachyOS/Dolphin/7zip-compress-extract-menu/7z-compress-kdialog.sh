...
# Явно вызываем функцию генерации имени архива. Присвоение функции к имени архива ее не инициализирует. Проверено эксперементальным путем. Возможно особенность BASH, в дальнейшем нужно изучить подробнее
generate_archive_name
