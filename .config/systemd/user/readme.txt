...
Пример 1: mako – сервис с привязкой к конкретным Wayland-сессиям
────────────────────────────────────────────────────────────────────────────────
[Unit]
...
Пример 3: mako через graphical-session.target с ConditionEnvironment
────────────────────────────────────────────────────────────────────────────────
[Unit]
Description=Lightweight notification daemon for Wayland
Documentation=man:mako(1) man:makoctl(1)
...
Пример 5: ydotoold – фоновый сервис с Type=simple
────────────────────────────────────────────────────────────────────────────────
[Unit]
...
Пример 6: пользовательский oneshot
────────────────────────────────────────────────────────────────────────────────
[Unit]
...
Пример 7: системные oneshot сервисы
────────────────────────────────────────────────────────────────────────────────
