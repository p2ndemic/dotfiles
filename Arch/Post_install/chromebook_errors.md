...
Эти ошибки указывают на проблемы с инициализацией драйверов, отвечающих за взаимодействие со встроенным контроллером ChromeOS (`cros-ec`). 
 Этот контроллер управляет клавиатурой (особенно функциональными клавишами), питанием, режимом сна/пробуждения, портами Type-C и другими низкоуровневыми функциями.  
